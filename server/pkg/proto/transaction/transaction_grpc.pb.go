...
type TransactionServiceClient interface {
	...
	GetByID(ctx context.Context, in *GetTransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error)
}
...
func (c *transactionServiceClient) GetByID(ctx context.Context, in *GetTransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponse)
...
type TransactionServiceServer interface {
	...
	GetByID(context.Context, *GetTransactionRequest) (*TransactionResponse, error)
...
func (UnimplementedTransactionServiceServer) GetByID(context.Context, *GetTransactionRequest) (*TransactionResponse, error) {
...
func _TransactionService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).GetByID(ctx, req.(*GetTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "server/proto/transaction.proto",
}
